package com.edbrix.contentbrix.volley;
...
public class VolleySingleton {
    ...
    public static final String PACKAGE_NAME = ContentBrixApp.class.getPackage().getName();
    ...
    private VolleySingleton(Context context) {
        mContext = context;
        wsBaseUrl = "http://knowledgebrix.smartwebi.com/";//"http://services.edbrix.net/";//Original//"http://knowledgebrix.smartwebi.com/";
