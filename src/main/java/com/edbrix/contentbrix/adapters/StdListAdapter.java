...
import com.edbrix.contentbrix.data.StandardData;
...
public class StdListAdapter extends BaseAdapter {
    ...
    private ArrayList<StandardData> listData;


    public StdListAdapter(Context context, ArrayList<StandardData> listData) {
    ...
    public View getDropDownView(int position, View view, ViewGroup parent) {
        ...
        textView.setText(listData.get(position).getStandard() + "");
        return view;
    }
