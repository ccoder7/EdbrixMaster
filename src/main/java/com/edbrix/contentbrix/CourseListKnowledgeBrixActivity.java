...
public class CourseListKnowledgeBrixActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_list_knowledge_brix);
        ...
        sessionManager = new SessionManager(CourseListKnowledgeBrixActivity.this);
        fileData = (FileData) getIntent().getSerializableExtra("FileData");
        userData = sessionManager.getLoggedKnowledgeBrixUserData();

        context = CourseListKnowledgeBrixActivity.this;
    ...
    private void getCourseList(String userId,String accessToken,String userType, String deviceType, String dataType, int pageNo) {
        try {
            ...
            GsonRequest<CourseListResponseData> getDashboardCourseSchedulesRequest = new GsonRequest<>(Request.Method.POST, tempUrl+"knowledgebrix/getknowledgebrixcourseslist", jo.toString(), CourseListResponseData.class,
...
//                                    showToast("No courses found.");
    ...
    private void createevalbrixcoursecontent(String userId, String courseId, String accessToken, String ContentTitle,
        ...
        try {
            ...
            String tempUrl = "https://services.edbrix.net/";
            JsonObjectRequest createCourseRequest = new JsonObjectRequest(Request.Method.POST, tempUrl + "knowledgebrix/createknowledgebrixcoursecontent", new JSONObject(requestMap), new Response.Listener<JSONObject>() {
                @Override
    ...
    private void uploadToEdbrix(final String id,
