package com.edbrix.contentbrix.rtc;
...
public class EngineConfig {
    ...
    private String mMuxStreamKey;

    public String getmMuxStreamKey() {
        return mMuxStreamKey;
    }

    public void setmMuxStreamKey(String mMuxStreamKey) {
        this.mMuxStreamKey = mMuxStreamKey;
    }
    ...
    public void setmChannelToken(String mChannelToken) {
        this.mChannelToken = mChannelToken;
    }
